        ...
        <div className="employee-header">
          ...
          <div className="employee-stats">
            ...
            <div className="stat-box">
              ...
              <span className="stat-label">Standard Employees</span>
            </div>
          </div>
        </div>
              ...
              <thead>
                <tr>
                  ...
                  <th onClick={() => handleSort('entry_date')}>
                    Entry Date
                    <span className="sort-indicator">
                      {sortConfig.key === 'entry_date' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                    </span>
                  </th>
                  <th>Actions</th>
                </tr>
              ...
              <tbody>
                {filteredEmployees.map((employee) => (
                  <tr key={employee.id}>
                    ...
                    <td>{new Date(employee.entry_date).toLocaleDateString()}</td>
                    <td>
                  ...
                  <div className="info-grid">
                    <div className="info-item">
                      ...
                      <div className="info-content">
                        ...
                        <span className="info-value">
                          {new Date(viewDialog.employee.entry_date).toLocaleDateString('en-US', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
                          })}
              ...
              <div className="form-section info-section">
                ...
                <div className="info-content">
                  ...
                  <div className="non-editable-items">
                    ...
                    <div className="non-editable-item">
                      <span className="item-label">Entry Date:</span>
                      <span className="item-value">{editDialog.employee.entry_date}</span>
                    </div>
                    <div className="non-editable-item">
